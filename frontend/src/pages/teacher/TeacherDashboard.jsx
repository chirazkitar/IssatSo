...
import { gradesAPI } from '../../api/apifetch';
  ...
  return (
    <div className="page">
      ...
      <div className="stats-grid">
        <StatCard glyph="" value={modules.length}   label="Modules assignés"   color="var(--accent2)" animClass="fade-up-1" />
        <StatCard glyph="‍" value={totalStudents}   label="Étudiants total"    color="var(--green)"   animClass="fade-up-2" />
        <StatCard glyph="" value={totalPassed}      label="Étudiants validés"  color="var(--gold)"    animClass="fade-up-3" />
        <StatCard
          glyph=""
